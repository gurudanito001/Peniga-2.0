  ...
  return (
    <>
      ...
      <div className='flex grow h-auto overflow-hidden w-full'>
        <section className='w-full lg:w-3/5 h-auto'>
            ...
            <div className='flex items-center'>
              ...
              <div className="drawer drawer-end w-24 ml-auto z-10">
                ...
                <div className='z-10 flex'>
                  {/* Page content here */}
                  <label htmlFor="trade-chat-drawer" className="btn btn-sm bg-primary ml-auto glass drawer-button gap-0 text-white ml-auto">
                ...
                <div className="drawer-side z-50">
                  ...
                  <ul className="menu p-0 w-[350px] min-h-full text-base-content bg-base">
                    <ChatSection />
                  </ul>
                </div>
              </div>
        ...
        <aside className='hidden lg:flex flex-col w-2/5 h-auto grow border border-purple-100 rounded-lg  text-base-content bg-purple-50'>
          <ChatSection />
        </aside>
